...
jugar():-     asignarPersonajes(Jugador1, Jugador2, TableroJ1, TableroJ2),
              ...
              write(" Vas a jugar contra otro oponente. ¡Que gane el mejor! \n"),
              turnos(ListaAtrJ1,ListaAtrJ2,TableroJ1,TableroJ2,1).

% ---------------------------------------------------------

% Función: turnos
% Juega un jugador por cada turno y cuando queda un personaje en uno de los tableros se acaba la partida

turnos(ListaAtrJ1,ListaAtrJ2,TableroJ1,TableroJ2,NumeroJugador):-
          num_elementos(TableroJ1,X),                                      % Comprueba el número de personajes que quedan en el tablero
          X = 1, write("¡¡Ha ganado el jugador 1!!\n\n"),
          imprimirCaras(ListaAtrJ2),!;                                     % OR
          num_elementos(TableroJ2,X),
          X = 1, write("¡¡Ha ganado el jugador 2!!\n\n"),
          ...
          turnos(ListaAtrJ1,ListaAtrJ2,RespuestaJ1,TableroJ2,2);           % OR  ||| TableroJ1 es la respuesta y ahora le toca a jugador 2
          ...
          turnos(ListaAtrJ1,ListaAtrJ2,TableroJ1,RespuestaJ2,1).           % TableroJ2 es la respuesta y ahora le toca a jugador 2
